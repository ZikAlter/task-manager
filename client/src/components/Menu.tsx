                    ...
                    <div className="mt-3 flex flex-col text-center">
                        ...
                        <div className="flex justify-center">
                            ...
                            <div className="ml-4 relative">
                                ...
                                <span className="absolute -top-1 -right-1 bg-red-600 text-white text-xs font-bold rounded-full w-5 h-5 flex items-center justify-center">0</span>
                            </div>
                        </div>

                        <div className="mt-4 flex flex-col md:flex-row md:justify-center gap-2">
                            <NavLink
                                to={'/setting'}
                                className="bg-blue-600 text-white hover:bg-blue-700 shadow-lg py-4 px-4 rounded-lg shadow-blue-400/90"
                            >
                                Настройки
                            </NavLink>
                            <button
